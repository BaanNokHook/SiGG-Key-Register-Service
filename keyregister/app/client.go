// Package keyregister provides a client to access https://keyregister.io/api and keyregister
// instances apis.
package keyregister
...
const (
	...
	DefaultHost = "http://keyregister.io"
	// DefaultEndpoint is the entry point for the api
	DefaultEndpoint = "/api/0/"
	// DefaultTimeout is the default and is set to 60 seconds
	DefaultTimeout = time.Duration(60) * time.Second
)

// Client is used to talk to a keyregister endpoint.
// Needs a auth token.
// If no endpoint this defaults to https://keyregister.io/api/0/
type Client struct {
	AuthToken  string
	Endpoint   string
