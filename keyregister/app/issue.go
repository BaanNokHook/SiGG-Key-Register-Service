...
// IssueTag is a tag used in a keyregister issue
...
//InternalUser is a user on keyregister and not a external customer
...
// Issue returns a issue found in keyregister
type Issue struct {
