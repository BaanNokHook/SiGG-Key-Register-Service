...
import (
	...
	"github.com/atlassian/go-keyregister-api/datatype"
)
...
// Entry is the entry for message/stacktrace/etc...
type Entry struct {
...
// Event is the event that was created on the app and keyregister reported on
type Event struct {
